...
namespace lab_92_XML_hello_world
{
    class Program
    {
        ...
        {
            Console.WriteLine("\n\nHelloWorld First Element\n");
            var xml01 = new XElement("testElement", 100);
            Console.WriteLine(xml01); // <testElement>100<\testElement>
            ...
            var xml04 = new XElement("testElement",
                new XElement("subElement",
                     ...
                     new XAttribute("height", 200), new XElement("subElement", new XElement("subElement", 600))),
                new XElement("subElement",
                     new XAttribute("width", 200),
                     new XAttribute("height", 200), 300),
                new XElement("subElement",
                     new XAttribute("width", 200),
                     new XAttribute("height", 200), 300)
