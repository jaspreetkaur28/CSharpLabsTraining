...
use ToDo
go
CREATE TABLE Categories(CategoryID INT NOT NULL IDENTIFY PRIMARY KEY, CategoryName NVARCHAR(50) NOT NULL); 
CREATE TABLE Users(UserID INT NOT NULL IDENTIFY PRIMARY KEY, UserName NVARCHAR(50) NOT NULL); 
CREATE TABLE Tasks(TaskID INT NOT NULL IDENTIFY PRIMARY KEY, 
